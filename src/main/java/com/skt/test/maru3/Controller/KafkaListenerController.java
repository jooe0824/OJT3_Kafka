...
public class KafkaListenerController {
     ...
     * 기존 List<Object> records -> List<ConsumerRecord<Object, String>> 로 변경가능
     * 후자로 변경 시 for(ConsumerRecord<Object, String> record : messages)
     * @param messages
     */
        ...
        try {
            ...
            for (String record : messages) {
                ...
                if(record != null && !record.isEmpty()) {
                    ...
                    KafkaData kafkaConsumerData = this.GSON.fromJson(record.toString(), KafkaData.class);
